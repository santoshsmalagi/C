...
int main(int argc, char *argv[])
{
  ...
  int i = 9;
  int *ptr = &i;                                    /* assigning address of a int variable */
  printf("&ptr = %p and *ptr = %d\n", ptr, *ptr);
  
  //ptr = 0;                                          /* assign p = 0 */        ------ Segmentation Fault (core dumped)
  //printf("&ptr = %p and *ptr = %d\n", ptr, *ptr);
  
  //ptr = NULL;                                       /* equivalent to p = 0 */ ------ Segmentation Fault (core dumped)
  //printf("&ptr = %p and *ptr = %d\n", ptr, *ptr);
  
  //ptr = (int*)9999;
  //printf("&ptr = %p and *ptr = %d\n", ptr, *ptr);   /* assigning p to an absolute address in memory */ ------ Segmentation Fault (core dumped)
